            ...
            <div className="col-md-12">
              <div className="pt-4">
                <p style={{ color: '#a40000' }}>
                  ...
                  <a href="">X Linez Software </a> {/* Pvt. Ltd */}
                </p>
              </div>
            </div>
          </div>
...
<div className=''>
  <h3 className="footer-heading mb-4">Our Company</h3>
  <ul className="list-unstyled">
    <li><Link className="nav-link mt-1" to={'/'}> Import Export </Link></li>
    <li><Link className="nav-link mt-1" to={'/'}> Softwares </Link></li>
  </ul>
</div>

<div className=''>
  <h3 className="footer-heading mb-4">Features</h3>
  <ul className="list-unstyled">
    <li><Link className="nav-link mt-1" to={'/aboutus'}> About Us </Link></li>
    <li><Link className="nav-link mt-1" to={'/service'}>Our Service</Link></li>
    <li><Link className="nav-link mt-1" to={'/contactus'}>Contact Us</Link></li>
